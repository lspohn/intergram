export const defaultConfiguration = {
  ...
  mainColor: '#277691',
  availabilityStart: 7, // Min. Hour of the day (UTC) where widget is shown
  availabilityEnd: 16, // Max. Hour of the day (UTC) where widget is shown
  availability2: false, // Enables second time interval (e.g. to enable 0-3 and 18-24 for other time zones)
  availabilityStart2: 0,
  availabilityEnd2: 0,
  availabilityDays: [1, 2, 3, 4, 5], // 0 = sunday, 6 = saturday
